...
export default class extends Component {
  constructor(props) {
    super(props);
    this.navigateToPackageSelectionScreen = this.navigateToPackageSelectionScreen.bind(
      this
    );
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={[styles.main]}>
          <View>
            <StyledHeader style={{ fontSize: 25, textAlign: "center" }}>
              Where would you like to send funds from?
            </StyledHeader>
          </View>
        </View>
          ...
          {paymentItems.map(provider => {
            return (
              <View style={{ marginRight: 20 }}>
                <TouchableOpacity
                  onPress={() =>
                    this.navigateToPackageSelectionScreen(provider)
                  }
                >
                  <View style={{ alignSelf: "center" }}>
                    ...
                    />
                    <StyledTextInverse style={{ alignSelf: "center" }}>
                      {provider.name}
                    </StyledTextInverse>
                  </View>
                </TouchableOpacity>
