...
function VerifyScreen({ navigation }) {
  ...
  const [validateLoginMember, { loading }] = useMutation(
    validateLoginMemberMutation,
    {
  ...
  return (
    <ScrollView style={{ flex: 1 }}>
      <View style={{ alignItems: "center", marginTop: 40 }}>
        <View>
          <StyledHeader style={{ fontSize: 25, color: "#434A59" }}>
            Verify Phone
          </StyledHeader>
        </View>
      ...
      <View
        style={{ paddingHorizontal: 10, alignSelf: "center", marginTop: 5 }}
      >
        <PinView
          pinLength={5}
          showInputs
